  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <div className="content">
        <div className="heading"><div><p>Settings <span>/</span> Subscription</p><h1>Subscription</h1><small>Manage pricing plans, module access, and your public pricing page.</small></div><div><Button variant="outline" onClick={() => setTab("landing")}><Eye />Preview landing page</Button><Button onClick={() => setPlanDialog(true)}><Plus />New plan</Button></div></div>
        ...
        <Tabs value={tab} onValueChange={setTab} className="tabs"><TabsList variant="line"><TabsTrigger value="plans">Plans & pricing</TabsTrigger><TabsTrigger value="modules">Module access</TabsTrigger><TabsTrigger value="landing">Landing page</TabsTrigger></TabsList>
