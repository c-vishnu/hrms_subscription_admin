...
export default function Home() {
  ...
  return <div className={`app-shell ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}>
    ...
    <main>
      <header className="topbar"><button className="menu" onClick={() => setMobileNav(true)}><Menu /></button><div className="top-actions"><Bell /><b>AK</b><ChevronDown /></div></header>
      <div className="content">
        <div className="heading"><div><p>Settings <span>/</span> Subscription</p><h1>Subscription</h1><small>Manage pricing plans, module access, and your public pricing page.</small></div><div className="heading-tools"><label className="search module-search"><Search /><input placeholder="Search customers, plans..." /><kbd>⌘ K</kbd></label><Button variant="outline" onClick={() => setTab("builder")}><Eye />Edit landing page</Button><Button onClick={() => setPlanDialog(true)}><Plus />New plan</Button></div></div>
